...
- [ ] 7A.6 Kuntien esityslistat (`agents/lahteet/kunnat/`) — RSS/iCal + CaseM/CloudNC, avoindata ja Dynasty-sovittimet puuttuu
...
- [ ] 7A.6 Kuntien esityslistat (RSS + CloudNC aloitettu)
