-- Salli kentän tyhjennys myös julkaisemattomalle hankkeelle (esiversio / agentin täydennys ennen julkaisua).

CREATE OR REPLACE FUNCTION julkaise_kentta_tyhjennys(
  p_ehdotus_id uuid,
  p_kasittelija text
)
RETURNS void
...
COMMENT ON FUNCTION julkaise_kentta_tyhjennys(uuid, text) IS
  'Hyväksyy kentta_tyhjennys-ehdotuksen: NULL arvo, poistaa lähteet. Toimii myös julkaisemattomalle hankkeelle. Agentti ei kutsu.';
